...
import {
  addRoomActionAsync,
  deleteRoomActionAsync,
  getApiRoomActionAsync,
  updateRoomActionAsync,
} from "@/app/redux/reducers/admin/roomReducer";
import { fetchLocationsAsync } from "@/app/redux/reducers/admin/locationApiReducer";
...
const Room = () => {
  ...
  const { locations } = useSelector((state) => state.locationApiReducer);
  ...
  const handleOk = async () => {
    if (modalType === "edit" && roomForm.id) {
      try {
        ...
        const updatedRooms = filteredData.map((room) =>
          room.id === roomForm.id ? { ...room, ...roomForm } : room
        );
            ...
            <div className="row">
              ...
              <div className="col-md-4 mb-3">
                ...
                <select
                  ...
                  onChange={(e) =>
                    setRoomForm({ ...roomForm, maViTri: e.target.value })
                  }
                  onBlur={(e) => {
                ...
                >
                  {locations?.map((location) => (
                    <option key={location.id} value={location.id}>
                      {location.id} - {location.tenViTri} - {location.tinhThanh} (
                      {location.quocGia})
                    </option>
                  ))}
                </select>
              ...
              <div className="col-md-4 mb-3">
                ...
                <input
                  ...
                  min="1"
                  onChange={(e) =>
                    setRoomForm({ ...roomForm, khach: e.target.value })
                  }
                  onBlur={(e) => {
                    const value = Math.max(1, Number(e.target.value) || 1);
            ...
            <div className="row">
              <div className="col-md-6 mb-3">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setRoomForm({ ...roomForm, tenPhong: e.target.value })
                  }
                />
              </div>
              <div className="col-md-6 mb-3">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setRoomForm({ ...roomForm, hinhAnh: e.target.value })
                  }
                />
              </div>
            </div>
            <div className="row">
              <div className="col-md-6 mb-3">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setRoomForm({ ...roomForm, phongNgu: e.target.value })
                  }
                  onBlur={(e) => {
                    const value = Math.max(1, Number(e.target.value) || 1);
              ...
              <div className="col-md-6 mb-3">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setRoomForm({ ...roomForm, giuong: e.target.value })
                  }
                  onBlur={(e) => {
                    const value = Math.max(1, Number(e.target.value) || 1);
            ...
            <div className="row">
              <div className="col-md-6 mb-3">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setRoomForm({ ...roomForm, phongTam: e.target.value })
                  }
                  onBlur={(e) => {
                    const value = Math.max(1, Number(e.target.value) || 1);
              ...
              <div className="col-md-6 mb-3">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setRoomForm({ ...roomForm, giaTien: e.target.value })
                  }
                  onBlur={(e) => {
                    const value = Math.max(1, Number(e.target.value) || 1);
  ...
  useEffect(() => {
    if (searchRoom.trim() === "") {
      ...
      const filtered = apiRoom.filter((room) =>
        removeDiacritics(room.tenPhong.toLowerCase()).includes(
          removeDiacritics(searchRoom.toLowerCase())
        )
      );
